...
namespace Educative.Infrastructure.QueryExtension
{
    public static class CourseExtension
    {
        ...
        public static IQueryable<Course> SearchCourses(this IQueryable<Course> query, string searchTerm)
        {
            ...
            return query.Where(c => c.CourseName != null && c.CourseName.ToLower().Contains(lowerCaseSearchTerm));
        }
        ...
        public static IQueryable<Course> FilterCourse(this IQueryable<Course> query, string courseName, string courseTopic)
        {
            ...
            query = query.Where(c => courseNameList.Count == 0 || (c.CourseName != null && courseNameList.Contains(c.CourseName.ToLower())));

            query = query.Where(c => courseTopicList.Count == 0 || (c.CourseTopic != null && courseTopicList.Contains(c.CourseTopic.ToLower())));
